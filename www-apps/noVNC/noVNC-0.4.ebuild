...
#EGIT_REPO_URI="https://github.com/kanaka/noVNC"
#EGIT_COMMIT="3516bdf3fa"
SRC_URI="https://github.com/downloads/kanaka/${PN}/${P}.tar.gz"
...
src_install() {
	...
	newconfd "${FILESDIR}/noVNC.confd-2012.2" noVNC
	newinitd "${FILESDIR}/noVNC.initd-2012.2" noVNC
